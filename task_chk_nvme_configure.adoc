...
Sigue ellink:kvm-host-configuration-and-preparation-checklist["lista de verificación de preparación del anfitrión"] y revise la información requerida para ellink:reference_chk_deploy_req_info.html["Implementar la instalación de la utilidad"] y ellink:reference_chk_select_req_info.html["Instalación de ONTAP Select"] Para obtener más información.
...
Verlink:concept_stor_capacity_inc.html["Aumentar la capacidad de almacenamiento"] Para obtener información adicional.
...
.. Seleccione *OK*. Los dispositivos seleccionados aparecen como *Disponibles (pendientes)*.
