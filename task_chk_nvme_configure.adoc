...
Sigue el link:kvm-host-configuration-and-preparation-checklist.html["lista de verificación de preparación del anfitrión"], y revisa la información requerida para el link:reference_chk_deploy_req_info.html["Implementar la instalación de la utilidad"] y el link:reference_chk_select_req_info.html["Instalación de ONTAP Select"] para más información.
