...
summary: Al crear o eliminar un clúster de ONTAP Select con ejemplos de código de Python, debe proporcionar un archivo JSON como entrada al script. Puede copiar y modificar el ejemplo JSON correspondiente según sus planes de implementación. 
---
